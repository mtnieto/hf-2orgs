...
instantiateChaincode () {
	...
	# lets supply it directly as we know it using the "-o" option
		...
		peer chaincode instantiate -o orderer.regulatory.com:7050 --tls $CORE_PEER_TLS_ENABLED --cafile $ORDERER_CA -C $CHANNEL_NAME -n mycontract -v 1.0 -c '{"Args":["init","a","100","b","200"]}' >&log.txt
